package com.tth.tclass;

import com.tth.iml.LoadingViewable;
...
public class SimpleLoadingView implements LoadingViewable {
	...
	public void toastResultInOtherWay(Context context, int state) {
		if (state == LoadingViewable.STATE_SUCCESS) {
		} else if (state == LoadingViewable.STATE_FAIL) {
